...
//	CREAR LOGIN
	public Login() {
		setResizable(false);
		setUndecorated(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(Busqueda.class.getResource("/imagenes/perfil-del-usuario.png")));
		...
		imgHotel.setFont(new Font("Georgia", Font.PLAIN, 11));
		imgHotel.setBounds(0, 0, 304, 538);
		panel_1.add(imgHotel);
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/imagenes/login_hotel.jpg")));
		...
		labelExit.setIcon(new ImageIcon(Login.class.getResource("/imagenes/cerrar-24px.png")));
		...
		txtUsuario.setFont(new Font("Georgia", Font.PLAIN, 16));
		...
		separator.setForeground(new Color(51, 102, 51));
		separator.setBackground(new Color(51, 102, 51));
		separator.setBounds(65, 292, 324, 2);
		panel.add(separator);
		
		JLabel labelTitulo = new JLabel("Iniciar sesión");
		labelTitulo.setForeground(new Color(51, 102, 51));
		labelTitulo.setFont(new Font("Georgia", Font.PLAIN, 26));
		...
		txtContrasena.setBackground(new Color(240, 255, 240));
		txtContrasena.setText("********");
		...
		txtContrasena.setFont(new Font("Georgia", Font.PLAIN, 16));
		txtContrasena.setBorder(javax.swing.BorderFactory.createEmptyBorder());
		txtContrasena.setBounds(65, 353, 324, 32);
		panel.add(txtContrasena);
		
		JLabel LabelUsuario = new JLabel("Usuario");
		LabelUsuario.setForeground(new Color(51, 102, 51));
		LabelUsuario.setFont(new Font("Georgia", Font.PLAIN, 20));
		LabelUsuario.setBounds(65, 219, 107, 26);
		panel.add(LabelUsuario);
		
		JLabel lblContrasea = new JLabel("Contraseña");
		lblContrasea.setForeground(new Color(51, 102, 51));
		lblContrasea.setFont(new Font("Georgia", Font.PLAIN, 20));
		...
		btnLogin.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnLogin.setBackground(new Color(0, 26, 0));
			}
		...
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/imagenes/logo-bonsai__150_-removebg-preview (50).png")));
